...
## rSmazeC43_ms55nw21_hExt025_engy_cposM
#------------------------ base ------------------------#
...
wall_input_dim = 3
vit1d_config = dict(
    input_size=num_walls * 3, patch_size=wall_input_dim, num_classes=0, 
    ...
    tf_config={'mish': False, 'wall_sinPosEmb': {'num_octaves': 4, 'norm_factor': 30}}
)
n_inj = 5e-3 / 5.
norm_const_dict = {'observations': (RAND_MAZE_MIN, RAND_MAZESIZE_55)}
base = {
    'dataset': "randSmaze2d-C43-ng3ks25k-ms55nw21-hExt05-v0",
    'diffusion': {
        'config_fn': '',
        ## model
        ...
        'renderer': 'utils.rm2d_render.RandStaticMazeRenderer',
        ...
        'preprocess_fns': ['maze2d_set_terminals_luo', 'append_center_mode_43'],
        'clip_denoised': True,
        'use_padding': False,


        'max_path_length': 35005,
        'max_n_episodes': 3200,
